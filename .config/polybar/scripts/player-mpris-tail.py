...
class Player:
    ...
    def _parseMetadata(self):
        if self._metadata != None:
            ...
            self.metadata['album']  = get_display(str(re.sub(SAFE_TAG_REGEX, """\1\1""", _getProperty(self._metadata, 'xesam:album', ''))))
            self.metadata['title']  = get_display(str(re.sub(SAFE_TAG_REGEX, """\1\1""", _getProperty(self._metadata, 'xesam:title', ''))))
            self.metadata['track']  = get_display(str(_getProperty(self._metadata, 'xesam:trackNumber', '')))
